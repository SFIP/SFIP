...
asmlinkage long sys_seccomp(unsigned int op, unsigned int flags,
			    void __user *uargs);
asmlinkage long sys_syscall_sequence(struct syscall_state_machine_user __user *machine, struct syscall_location_info_user __user *syscall_locs, unsigned long flags);
